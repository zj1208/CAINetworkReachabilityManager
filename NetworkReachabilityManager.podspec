...
Pod::Spec.new do |s|
  s.name             = 'NetworkReachabilityManager'
  s.version          = '0.1.0'
  s.summary          = '一个NetworkReachabilityManager.'
...
基于AFNetworkReachabilityManager封装的及时回调是否有网络
  ...
  s.source           = { :git => 'https://github.com/zj1208/NetworkReachabilityManager.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'NetworkReachabilityManager/Classes/**/*'
