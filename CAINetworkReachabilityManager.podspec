#
# Be sure to run `pod lib lint CAINetworkReachabilityManager.podspec' to ensure this is a
...
基于AFNetworkReachabilityManager封装的一个方法回调是否有网络，用于某些特定场景需要交互检查使用。
  ...
  # s.resource_bundles = {
  #   'CAINetworkReachabilityManager' => ['CAINetworkReachabilityManager/Assets/*.png']
  # }
